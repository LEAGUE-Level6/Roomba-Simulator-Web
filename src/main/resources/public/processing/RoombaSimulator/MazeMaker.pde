public class MazeMaker {
  ...
  private ArrayList<Maze> mazeSteps = new ArrayList<Maze>();
  ...
  private void removeWalls(Cell a, Cell b) {
    ...
    mazeSteps.add(new Maze(new ArrayList(horizontalPaths), new ArrayList(verticalPaths)));
  ...
  public ArrayList<Maze> getMazeSteps() {
    return mazeSteps;
  }
}